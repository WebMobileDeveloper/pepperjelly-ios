...
@property NSString* changedUserBioString;
...
- (IBAction)backButtonPressed:(id)sender {
    if(self.changedUserBioString != nil){
        if([self.changedUserBioString  isEqual: @""]){
            self.changedUserBioString = @"\n";
        }
        UserModify *user = [[UserModify alloc] initWithUser:[APIManager sharedInstance].user];
        user.userBio = self.changedUserBioString;
...
-(void)changeUserBio:(NSString*)userbio{
    self.changedUserBioString=userbio;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // User Bio
        ...
        if(APIManager.sharedInstance.user.userBio == nil || [APIManager.sharedInstance.user.userBio  isEqual: @"\n"] ){
            cell.userBioTextView.text= @"";
        }else{
