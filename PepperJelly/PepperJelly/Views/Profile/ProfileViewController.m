...
- (void)syncronize{
    ...
    if([strUserBio isEqualToString:@""] || [strUserBio isEqualToString:@"\n"]) {
        self.userBioSpaceConstraint.constant = 0;
    }
    else if(![strUserBio isEqualToString:@"\n"]) {
        self.userBioSpaceConstraint.constant = 20;
    }
...
-(void)openUploadedPhoto:(Dish *)dish{
    ...
    RestaurantViewController *restaurantViewController = [storyboard instantiateViewControllerWithIdentifier:@"Restaurant"];
    restaurantViewController.dish = dish;
