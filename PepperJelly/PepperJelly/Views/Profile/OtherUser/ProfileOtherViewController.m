...
@property (strong, nonatomic) IBOutlet UILabel *userBioLabel2;
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *userBioHeightConstraint;
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *userBioPaddingBottomConstraint;
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *topSectionHeightConstraint;
...
-(void)syncronize{
    ...
    if (self.user.userBio != nil){
        strUserBio = self.user.userBio;
    } else {
        strUserBio = @"";
    }
    
    if([strUserBio isEqualToString:@"\n"]) {
        self.userBioLabel2.text = @"";
        strUserBio = @"";
    }
    
    if([strUserBio isEqualToString:@""] || [strUserBio isEqualToString:@"\n"]) {
        //self.userBioHeightConstraint.constant = 0;
        self.userBioPaddingBottomConstraint.constant = 0;
        //self.topSectionHeightConstraint.constant = 245;
    }
    else if(![strUserBio isEqualToString:@"\n"]) {
        //self.userBioHeightConstraint.constant = 20;
        self.userBioPaddingBottomConstraint.constant = 10;
        //self.topSectionHeightConstraint.constant = 275;
    }
    ...
    self.userBioLabel2.attributedText = attributeString;
